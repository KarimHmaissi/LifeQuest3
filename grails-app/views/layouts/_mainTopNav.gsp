<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown header-border">
                ...
                <ul class="dropdown-menu block-dark messages msg-notify">
                    ...
                    </li><li><a href="#"><div><i class="icon-twitter"></i>  new follower <span class="timer">6 min</span></div></a>
                </li><li><a href="#"><div><i class="icon-thumbs-up"></i> new like <span class="timer">9 min</span></div></a>
                </li><li><a href="#"><div><i class="icon-twitter"></i>  new follower <span class="timer">25 min</span></div></a>
                </li><li><a href="#"><div><i class="icon-user"></i>  new registration <span class="timer">32 min</span></div></a>
                </li><li><a href="#"><div><i class="icon-comment"></i>  new comment <span class="timer">2 hours</span></div></a>
                </li><li><a href="#"><div><i class="icon-map-marker"></i>  new localization <span class="timer">Yesterday</span></div></a>
                </li></ul>
            </li>
        ...
        <a class="brand" href="index.html"><span class="title">Life Quest</span> <span class="logo"></span></a>
    </div>
</div><!-- navbar -->