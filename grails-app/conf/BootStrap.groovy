...
class BootStrap {
    ...
    private void createDummyData() {
        ...
        for(int x = 0; x < 5; x++) {
            ...
            link1.title = "Startups, This is How Design Works 1"
            link1.type = "Article"
            link1.xpGain = 20
            ...
            link2.title = "Startups, This is How Design Works 2"
            link2.type = "Article"
            link2.xpGain = 20
            ...
            link3.title = "Startups, This is How Design Works 3"
            link3.type = "Article"
            link3.xpGain = 20
            ...
            link4.title = "Startups, This is How Design Works 4"
            link4.type = "Article"
            link4.xpGain = 20
            ...
            quest.title = "Become a master of bootstrap " + x
            ...
            quest.addToTasks(link1)
            quest.addToTasks(link2)
            quest.addToTasks(link3)
            quest.addToTasks(link4)
            quest.save(failOnError: true)

            println "finished loading dumy data"
